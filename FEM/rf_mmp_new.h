...
public:
	...
	double PermeabilityFunctionPressPlastic(long index, int nnodes, double pressure, CFiniteElementStd* h_fem); // LU:09.2018
	double StorageFunctionEffStress(long index, int nnodes, CFiniteElementStd* h_fem); // AS 08.2012
	double StorageFunctionPressPlastic(long index, int nnodes, double pressure, CFiniteElementStd* h_fem); // LU:09.2018
	double PorosityVolStrain(long index, double val0, CFiniteElementStd* assem); // WX: 03.2011
	double PorosityFunctionEffStress(long index, CFiniteElementStd* h_fem); // AS:08.2012
...
public:
	...
	double permeability_effstress_model_value[10]; // LU:perlmeability function eff stress 06.2018
	int permeability_effstress_model;
	double storage_effstress_model_value[10]; // LU:storage function eff stress 06.2018
